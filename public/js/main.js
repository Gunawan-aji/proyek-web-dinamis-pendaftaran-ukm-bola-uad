        ...
        form.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    formMessage.textContent = result.message || 'Pendaftaran gagal. Silakan coba lagi.';
                }

            } catch (error) {
                console.error('Error saat submit form:', error);
                formMessage.classList.add('message-error');
                formMessage.textContent = 'Terjadi kesalahan jaringan atau server. Detail: ' + error.message;
            } finally {
